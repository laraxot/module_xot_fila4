# Enum Standards in <main module>

This document defines the standards and best practices for working with Enums in the <main module> project.
...
namespace Modules\<main module>\Enums;
...
// Alias for backward compatibility
class_alias(AppointmentTypeEnum::class, 'Modules\\<main module>\\Enums\\AppointmentType');
```
