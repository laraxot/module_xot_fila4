...
### property_exists() NON con i Modelli Eloquent
...
// ✅ CORRETTO - Usa hasAttribute(), isFillable() o isset()
...
### Metodi con Array Misti

I metodi come `getTableColumns`, `getFormSchema`, `getTableBulkActions`, `getTableActions`, `getTableFilters`, `getHeaderActions` restituiscono sempre array con chiavi miste. Evita di usare `mixed` quando possibile:
...
public static function getTableColumns(): array
{
    return [
        ...
        'email' => EmailColumn::make('email'),
    ];
}

// ✅ CORRETTO - Specifica i tipi delle chiavi
/**
