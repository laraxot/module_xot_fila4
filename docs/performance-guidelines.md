...
When processing millions of records (e.g., imports/exports), follow these high-performance patterns:

### 1. Disable Overhead
```php
use Illuminate\Support\Facades\DB;

// Disable logging and events for bulk operations
DB::disableQueryLog();
DB::connection()->unsetEventDispatcher();
```

### 2. Streaming with Lazy Collections
```php
...
For more details, see the [Global Large Data Processing Standard](../../docs/standards/large-data-processing.md).
